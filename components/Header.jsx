...
return navigator(`/search?q=${queryTerm}`);
  ...
  <div className="container-fluid">
    ...
    <a href="#" className="navbar-brand">  <i className="bi bi-film"></i>   MovieHunt
    </a>
   <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#menu" > <span className="navbar-toggler-icon"></span></button>
